...
export default function PageHeader({ eyebrow, title, subtitle, actions, artwork, artworkAlt = "" }) {
  return <header className={`page-header ${artwork ? "page-header-with-artwork" : ""}`}>
    {artwork && <GameIllustrationFrame src={artwork} alt={artworkAlt} code={title} ratio="5 / 1" className="page-header-artwork" />}
